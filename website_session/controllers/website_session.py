...
class Partner(Controller):
    ...
    def create_partner(self, **kw):
        ...
        partner_ids = request.env['res.partner'].sudo().search([], limit=1, order='create_date desc')
    ...
    def view_partner(self, partner):
        return request.render('website_session.partner_view_temp',
            {'partner': partner})
